# Generated by Django 3.2.8 on 2021-12-09 12:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_date', models.DateField(default='2021-12-09', verbose_name='创建日期')),
            ],
        ),
        migrations.CreateModel(
            name='RollingPic',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True, verbose_name='创建日期')),
                ('update_time', models.DateTimeField(auto_now=True, verbose_name='更新日期')),
                ('templates', models.OneToOneField(help_text='\n                                                           <a href="/api/templates/add/" class="mt-2"><i class="fadeIn animated bx bx-plus-circle">新增</i></a>\n                                                                 ', on_delete=django.db.models.deletion.CASCADE, to='api.templates', verbose_name='模板')),
                ('test_suit', models.ForeignKey(help_text='\n                                      <a href="/api/testsuit/add/" class="mt-2"><i class="fadeIn animated bx bx-plus-circle">新增</i></a>\n                                           ', on_delete=django.db.models.deletion.CASCADE, to='api.testsuit', verbose_name='用例集合')),
            ],
            options={
