...
class GenerateCompareReport:
    ...
    def _generateCNHtml(self, *args, cn_map_dic=None, black_list=None):
        ...
        return fieldList, field_cn, list(Dict_list[0].values()), list(Dict_list[1].values()), list(
            ...
            Dict_list[3].values()), compareResult

    def _generateHtml(self, senerioName, *args,url='未配置',
                      message1='消息1', message2='TBS-DP-0039', message3='ODM-DP-0039'):
        """
        ...
        <!DOCTYPE html>
            ...
            function filter_table(elem) {
               ...
               ''' % (senerioName,url,url, message1, message2, message3)
...
if __name__ == "__main__":
    ...
    dict2 = {'ordrCd': '200629050100000009', 'dtCnfrm': '2020-06-29 00:00:00', 'prdctCd': 'CBT', 'trdngMdCd': 'ODM',
             'trdngMthdCd': 'Matching', 'qtTp': '5', 'ordrSt': '0', 'srNoId': '133210', 'traTlCd': '140409',
             'bndsNm': '14农发09', 'bondCcy': 'CNY', 'instnCd': '401352', 'cfetsInstnCd': '170050044030000213011',
             'instnCnShrtNm': '阳光资管', 'trdrCd': '30086', 'trdngAcntCd': '401352',
             'trdAcntCfetsCd': '170050044030000213011', 'trdAcntCnShrtNm': '阳光资管', 'dir': 'B', 'netPrc': '102.3335',
             'exrcsYld': '', 'flxblSpd': '', 'flxblNetPrc': '', 'flxblYldToMrty': '',
             'flxblExrcsYld': '', 'nmnlVol': '120000000.0', 'stlmntSpdNm': '2', 'clrngMthd': '2', 'stlmntMthdNm': '1',
             'stlmntDt': '2020-06-30 00:00:00', 'acrdIntrst': '1.9864754098', 'allPrc': '104.3199754098',
             'totlAcrdIntrst': '2383770.49180328', 'amnt': '122800200.0', 'stlmntCcy': '',
             'stlmntAmnt': '125183970.491803', 'mktScp': '1', 'chnlTp': '4', 'chnl': '', 'ttmYrly': '0.64Y',
             'qtSrc': '0', 'ocoOrdrCd': '', 'ifdoneOrdrCd': '', 'bondTpId': '100003', 'bondTpNm': '政策性金融债',
             'trdrNm': '郭程程', 'dlAmnt': '', 'ttm': '236D', 'oprtnTp': 'N',
             'isrCd': '101915', 'prmrktBondF': '0', 'alctnIndctr': '0'}
    ...
    dict4 = {'alctnIndctr': '0','dtCnfrm': '2020-06-29 00:00:00', 'prdctCd': 'CBT', 'trdngMdCd': 'ODM',
             'trdngMthdCd': 'Matching', 'qtTp': '5', 'ordrSt': '0', 'srNoId': '133210', 'traTlCd': '140409',
             'bndsNm': '14农发09', 'bondCcy': 'CNY', 'instnCd': '401352', 'cfetsInstnCd': '170050044030000213011',
             'instnCnShrtNm': '阳光资管', 'trdrCd': '30086', 'trdngAcntCd': '401352',
             'trdAcntCfetsCd': '170050044030000215011', 'trdAcntCnShrtNm': '阳光资管', 'dir': 'B', 'netPrc': '102.3335',
             'yldToMrty': '1.8363672583', 'exrcsYld': '', 'flxblSpd': '', 'flxblNetPrc': '', 'flxblYldToMrty': '',
             'flxblExrcsYld': '', 'nmnlVol': '120000000.0', 'stlmntSpdNm': '2', 'clrngMthd': '2', 'stlmntMthdNm': '1',
             'stlmntDt': '2020-06-30 00:00:00', 'acrdIntrst': '1.9864754098', 'allPrc': '104.3199754098',
             'totlAcrdIntrst': '2383770.49180328', 'amnt': '122800200.0', 'stlmntCcy': '',
             'stlmntAmnt': '125183970.491803', 'mktScp': '1', 'chnlTp': '4', 'chnl': '', 'ttmYrly': '0.64Y',
             'qtSrc': '0', 'ocoOrdrCd': '', 'ifdoneOrdrCd': '', 'bondTpId': '100003', 'bondTpNm': '政策性金融债',
             'trdrNm': '郭程程', 'rmngTotlAmnt': '120000000.0', 'dlAmnt': '', 'ttm': '236D', 'oprtnTp': 'N',
             'isrCd': '101915', 'prmrktBondF': '0', }

    sample = GenerateCompareReport()

    dict_tuple = (dict1, dict2, dict3, dict4)

    field_result = sample._generateCNHtml(dict_tuple, cn_map_dic=projectFieldMapDict, black_list=None)

    html = sample._generateHtml("4条信息对比", field_result)
